...
<div>
    ...
    <form method="POST" action="{{ route('login.post') }}">
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" id="email" value="{{ old('email') }}" class="form-control @error('email') is-invalid @enderror" placeholder="nama@email.com" required autofocus>
            @error('email')
        ...
        <div class="mb-3 position-relative">
            ...
            <div class="input-group">
                ...
                <button type="button" class="btn btn-outline-secondary" onclick="togglePassword()" aria-label="Toggle password">
